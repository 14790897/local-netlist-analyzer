...
![启动页](./images/demo-01-startup.png)

点击后展开 6 个子项 — 局部网表分析、AI 一键、整图分析、AI 设置、AI 对话:

![顶菜单子项](./images/demo-02-topmenu-submenu.png)

**整图分析**:一键出 AI 分析,自动列出 56 个元件的 LCSC 编号清单 + 让 deepseek-v4-pro 推理:

![整图分析 AI 面板](./images/demo-03-ai-whole-schematic.png)

**未框选时**点"分析选中区域"会提示先框选:

![未框选提示](./images/demo-04-no-selection-warning.png)
